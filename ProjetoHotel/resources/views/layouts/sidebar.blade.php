<nav id="sidebar">
    ...
    <aside class="app-sidebar">
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item active" href="{{ url('/cliente/home') }}"><i class="app-menu__icon fa fa-dashboard"></i><span
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item" href="{{ url('/quarto/listar') }}"><i
                                class="icon fa fa-circle-o"></i>Quarto</a></li>
                    <li><a class="treeview-item" href="{{ url('/reservar/listar') }}"><i
                                class="icon fa fa-circle-o"></i>Reservar</a></li>
                    <li><a class="treeview-item" href="{{ url('/pagamento/listar') }}"><i
                                class="icon fa fa-circle-o"></i>Pagamento</a></li>
